...
interface ConfirmActionModalProps {
  isOpen: boolean;
  onClose: () => void;
  // Accepte une fonction synchrone ou asynchrone — le `await` interne marche dans les deux cas
...
// Export nommé alias — utilisé par les anciens composants qui importent { ConfirmationModal }
// Permet de migrer progressivement sans casser les imports existants
export { ConfirmActionModal as ConfirmationModal };
