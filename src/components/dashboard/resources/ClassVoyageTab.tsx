        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Gérez les différentes classes et niveaux de service
            </p>
          </div>
          <button
        ...
        <div className="text-center py-16 bg-white rounded-xl border border-gray-100">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">
            {searchTerm
              ...
              : "Aucune classe de voyage définie"}
          </h3>
          ...
          <table className="min-w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredClasses.map((cls, index) => {
                ...
                const cancellationBadge = getCancellationBadge(
                  cls.tauxAnnulation || 0,
                );
                  ...
                  >
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center justify-center gap-4">
                        <div
                          className={`w-12 h-12 rounded-full ${classColor} flex items-center justify-center text-white text-lg font-bold shadow-md`}
                        >
                          {priceBadge.icon}
                        </div>
                    ...
                    <td className="px-8 py-6 text-center">
                      <span
                        className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${priceBadge.color}`}
                      >
                    ...
                    <td className="px-8 py-6 text-center">
                      <span
                        className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${cancellationBadge.color}`}
                      >
