...
import { X, User, Mail, Phone, Lock, Plus, Edit3, UserCheck } from "lucide-react"
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold">
                  {isEditMode ? "Modifier le chauffeur" : "Ajout d'un nouveau chauffeur"}
                </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50/50 rounded-xl p-4 border border-gray-100">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-sm font-semibold text-gray-900">Informations de contact</h3>
                </div>
            ...
            >
              {isSubmitting ? (
                  ...
                  <>
                    ...
                    {isEditMode ? "Enregistrer les modifications" : "Créer le chauffeur"}
                  </>
              )}
            </button>
            <button
