...
export default function StatisticSection(): JSX.Element {
    ...
    return (
        <motion.div
            ...
            variants={fadeInUp}
            className="relative text-base-color py-10 md:py-52 statistic-section"
        >
            <div className="container px-4">
                <motion.div variants={fadeInUp} className="text-center mb-16">
                    <h2 className="md:-mt-28 text-3xl md:text-5xl font-bold mb-6 text-base-color">
                        {translate("title")}
                    </h2>
                    <p className="text-lg md:text-xl text-base-color max-w-3xl mx-auto">
                        {translate("slogan")}
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <motion.div variants={fadeInLeft} className="bg-base-color/90 p-8 rounded-xl shadow-xl hover:transform hover:-translate-y-6 transition duration-500">
                        ...
                        <p className="text-gray-600 text-center">{translate("followUpReservationText")}</p>
                    </motion.div>

                    <motion.div variants={fadeInUp} className="bg-base-color/90 p-8 rounded-xl shadow-xl hover:transform hover:-translate-y-6 transition duration-500">
                        <div className="flex justify-center mb-5">
                        ...
                        <p className="text-gray-600 text-center">{translate("cancellationAnalyticsText")}</p>
                    </motion.div>

                    <motion.div variants={fadeInRight} className="bg-base-color/90 p-8 rounded-xl shadow-xl hover:transform hover:-translate-y-6 transition duration-500">
                        <div className="flex justify-center mb-5">
                        ...
                        <p className="text-gray-600 text-center">{translate("commerceCustomText")}</p>
                    </motion.div>
                </div>
            </div>
        </motion.div>
