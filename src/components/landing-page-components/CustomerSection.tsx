...
export default function CustomerSection(): JSX.Element {
    ...
    return (
        <motion.div
            ...
            className="py-10 md:py-5 bg-base-color flex flex-col"
        >
            <div className="container px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                    <motion.div variants={fadeInLeft}>
                        <div className="relative h-[260px] sm:h-[380px] md:h-[500px] w-full rounded-lg overflow-hidden shadow-xl">
                            <Image
                        ...
                        <div className="space-y-6 md:space-y-8">
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">{translate("freeSearchText")}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">{translate("flexiblePaymentText")}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">{translate("reservationManagementText")}</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
