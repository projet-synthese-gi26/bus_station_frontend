...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIsSubmitted(true);
      // En DEV, le backend renvoie aussi un debugToken pour faciliter les tests.
      ...
      if (axios.isAxiosError(err) && err.response?.status === 400) {
        ...
        // On affiche tout de même le message générique pour éviter l'énumération
        setIsSubmitted(true);
      }
    } finally {
      setIsLoading(false);
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-white text-center">
          ...
          <p className="text-blue-100 mt-2">
            Réinitialisez votre mot de passe Bus Station
          </p>
        </div>
        ...
        <div className="p-6 md:p-8">
          {!isSubmitted ? (
            ...
            >
              ...
              {/* Bloc DEV : affiche le debugToken renvoyé par le backend en environnement de test */}
              {debugToken && (
                <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-left">
                  ...
                  <p className="text-xs text-yellow-700 mb-3 break-all font-mono">
                    {debugToken}
                  </p>
                  <Link
              ...
              <p className="text-gray-500 text-sm mb-6">
                N&#39;oubliez pas de vérifier vos dossiers de spam ou courrier
                indésirable.
              </p>
              <motion.button
                onClick={() => {
